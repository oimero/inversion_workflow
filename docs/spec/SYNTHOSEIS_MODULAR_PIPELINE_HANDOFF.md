...
| validation 与 checkpoint | `ginn_v2/composable.py`、`ginn_v2/checkpoint.py` | 深度 smoke 输出 base、13 view、3 组 family 和 paired 指标；`load_checkpoint` 严格读取 v5 provenance |
