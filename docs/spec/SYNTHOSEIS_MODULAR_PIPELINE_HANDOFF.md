...
seismic_views:
  operators:
    ...
    rgt_lateral_gain:
      kind: rgt_lateral_gain
      rgt_log_sigma: 0.10
      rgt_correlation_length: 0.35
      lateral_log_sigma: 0.10
      lateral_correlation_length_m: 3000.0
      interaction_log_sigma: 0.08
      interaction_rank: 2
      interaction_rgt_correlation_length: 0.25
      interaction_lateral_correlation_length_m: 3000.0
      max_abs_log_gain: 0.60
  ...
  views:
    ...
    - view_id: rgt_lateral_gain
      operator_ids: [rgt_lateral_gain]
...
sampling:
  ...
  view_weights:
    global_gain: 0.25
    tracewise_gain: 0.25
    axis_lateral_gain: 0.25
    rgt_lateral_gain: 0.25
```
