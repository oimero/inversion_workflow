...
def prepare_dataset(save_dir):
    ...
    train_creator, val_creator = create_or_load_synthetic_dataset(
        h5_file, h5_group_training, h5_group_validation, params
    )
...
def search():
    ...
    ax_client.create_experiment(
        ...
        objectives={"reconstruction_error": ObjectiveProperties(minimize=True)},
    ...
    for i in tqdm(range(NUM_SAMPLING)):
        ...
        learner = LightVariationalModel(base_train_dataset, base_val_dataset, current_params)
