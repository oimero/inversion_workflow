...
def main():
    ...
    logger = Logger(WORKDIR / "experiment.log")  # type: ignore
...
def train():
    ...
    training_creator, validation_creator = create_or_load_synthetic_dataset(
        h5_file, h5_group_training, h5_group_validation, parameters["synthetic_dataset"]
    )
    ...
    learner = VariationalModel(
        save_dir,
        base_train_dataset,
        base_val_dataset,
        params,
        logger,
        tensorboard=tensorboard,  # type: ignore
    )
