...
METRICS_FIELDNAMES = [
    ...
    "synthetic_residual_highpass",
    "synthetic_spectrum",
    "synthetic_rms",
    "synthetic_rms_underfit",
    "synthetic_waveform_term",
    "synthetic_residual_lowpass_term",
    "synthetic_residual_highpass_term",
    "synthetic_spectrum_term",
    "synthetic_rms_term",
    "synthetic_rms_underfit_term",
    "synthetic_residual_mean",
    "synthetic_pred_residual_rms",
    "synthetic_target_residual_rms",
    "synthetic_residual_rms_ratio",
    "synthetic_pred_highpass_rms",
    "synthetic_target_highpass_rms",
    "synthetic_highpass_rms_ratio",
    "synthetic_zero_waveform_mae",
    "synthetic_model_vs_zero_waveform_gain",
    "train_loss",
    "train_waveform_mae",
    "train_residual_l2",
    "train_l2_term",
